...
pub const AUDIO_EXTS: &[&str] = &[
    "mp3", "wav", "flac", "aac", "ogg", "wma", "m4a", "aiff", "aif", "mid", "midi",
    "amr", "ape", "au", "mka", "opus", "ra", "wavpack", "wv", "pcm", "dsd", "dff",
    "dsf",
];

pub const VIDEO_EXTS: &[&str] = &[
    "mp4", "mkv", "avi", "mov", "wmv", "webm", "flv", "mpg", "mpeg", "m4v", "3gp",
    "3g2", "vob", "ogv", "asf", "rm", "rmvb", "ts", "m2ts", "mts", "divx", "f4v",
    "qt",
];
...
pub const DOCUMENT_EXTS: &[&str] = &[
    "pdf", "doc", "docx", "txt", "rtf", "odt", "pages", "wpd", "tex", "epub", "mobi",
    "azw", "azw3", "csv", "xls", "xlsx", "ods", "ppt", "pptx", "odp",
];
