    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-md transition-all duration-300">
      ...
      >
        ...
        <p className="text-sm mb-6" style={{ color: "var(--text-secondary)" }}>
          A new version of MxSend is available with exciting features and
          performance improvements. Upgrade now to get the best experience!
        </p>
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
          ...
          <Button
            ...
            attrs={{
              onClick: async () =>
                await openUrl("https://mxsend.vercel.app/downloads"),
            }}
          >
            Download Now
          </Button>
